...
echo -e "\e[1;32m Installing qbittorrent \e[0m"
apt autoremove -y transmission
apt install -y qbittorrent

echo -e "\e[1;32m Installing nvidia-detect \e[0m"
apt install -y nvidia-detect

echo -e "\e[1;32m Installing zip unzip 7zip \e[0m"
apt install -y zip unzip 7zip

echo -e "\e[1;32m Installing mpv \e[0m"
apt install -y mpv mpv-mpris subliminal

echo -e "\e[1;32m Installing conky nefetch htop \e[0m"
apt install -y conky neofetch htop

echo -e "\e[1;32m Installing clipboard manager diodon \e[0m"
